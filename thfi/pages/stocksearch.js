...
function StockSearch({data}){
    ...
    const fetchData = (e) => {
     ...
     useEffect(() => {
        console.log(JSON.stringify(selectedStockData) + "use effect");
     },[selectedStockData])
...
<body> 
    ...
    <Toolbar/>
    <div class="light-mode bg-light  bg-size-cover bg-repeat-0 bg-position-center position-relative overflow-hidden py-5 mb-4">
        ...
        <div className="col-lg-6 mx-auto text-center" >
                ...
                <button type="button" class="btn btn-primary btn-rounded mt-4">Search</button>
        </div>
    <div class="container"> 
        <table class="table table-hover">
            ...
            <tbody>
                <h2> <h1>{message}</h1>  {responseData ? responseData.symbol : ''}</h2>
